// =============================================================================
// Item Detail View – detail předmětu + vyzvednutí
// =============================================================================

const ItemDetailView = {
    render(params) {
        const item = DataService.getItem(params.id);
                    ...
                    <div class="detail__info-section">
                        ...
                        ` : `
                            <div class="detail__pickup-form" id="pickup-section">
                                ...
                                <form onsubmit="ItemDetailView.handlePickup(event, '${item.id}')" class="detail__pickup-inline">
...
console.log('ItemDetailView loaded');
